...
const pickOneSentence = function(rawText){
...
const readTextFile = function(textRef){
...
module.exports = {fullDate: dateNowFormattedET, fullTime: timeNowFormattedET, partOfDay: partOfDay, listWisdom: listWisdom, pickOneSentence: pickOneSentence, readTextFile: readTextFile};
